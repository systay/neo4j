...
public class NodePropertyUpdateImpl implements NodePropertyUpdate
{
    ...
    private NodePropertyUpdateImpl( long nodeId, int propertyKeyId, Object valueBefore, long[] labelsBefore,
    ...
    public boolean equals( Object obj )
    {
        ...
        NodePropertyUpdateImpl other = (NodePropertyUpdateImpl) obj;
    ...
    {
        return new NodePropertyUpdateImpl( nodeId, propertyKeyId, null, EMPTY_LONG_ARRAY, value, labels, ADDED );
    }
    ...
    {
        return new NodePropertyUpdateImpl( nodeId, propertyKeyId, valueBefore, labelsBefore, valueAfter, labelsAfter,
                CHANGED );
    }

    public static NodePropertyUpdate remove( long nodeId, int propertyKeyId, Object value, long[] labels )
    {
        return new NodePropertyUpdateImpl( nodeId, propertyKeyId, value, labels, null, EMPTY_LONG_ARRAY, REMOVED );
    }
}
