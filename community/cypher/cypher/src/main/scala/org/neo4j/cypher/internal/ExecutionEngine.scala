...
class ExecutionEngine(val queryService: GraphDatabaseQueryService,
...

  {
    ...
    BuildInterpreted2ExecutionPlan.graphDatabase = queryService.asInstanceOf[GraphDatabaseQueryService]
    println("w00t")
  } // TODO: This is a major hack to cut through all the layers
