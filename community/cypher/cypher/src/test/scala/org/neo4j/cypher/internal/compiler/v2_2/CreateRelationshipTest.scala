...
import org.neo4j.cypher.internal.compiler.v2_2.commands.expressions.{Identifier, ParameterExpression}
import org.neo4j.cypher.internal.compiler.v2_2.mutation.{CreateRelationship, RelationshipEndpoint}
...
class CreateRelationshipTest extends GraphDatabaseFunSuite {
  ...
  test("should accept Java arrays as properties for relationships") {
    ...
    try {
      ...
      val ctx = ExecutionContext("a" -> a, "b" -> b)
