...
case class Equals(lhs: Expression, rhs: Expression) extends Expression with BinaryOperatorExpression with InfixFunctionTyping {
  ...
  def switchSides: Equals = copy(rhs, lhs)
}
...
case class StartsWith(lhs: Expression, rhs: Expression) extends Expression with BinaryOperatorExpression with InfixFunctionTyping {
  val signatures = Vector(
    Signature(argumentTypes = Vector(CTString, CTString), outputType = CTBoolean)
  )
}

case class EndsWith(lhs: Expression, rhs: Expression) extends Expression with BinaryOperatorExpression with InfixFunctionTyping {
  val signatures = Vector(
    Signature(argumentTypes = Vector(CTString, CTString), outputType = CTBoolean)
  )
}

case class Contains(lhs: Expression, rhs: Expression) extends Expression with BinaryOperatorExpression with InfixFunctionTyping {
  val signatures = Vector(
    Signature(argumentTypes = Vector(CTString, CTString), outputType = CTBoolean)
  )
}
...
final case class LessThan(lhs: Expression, rhs: Expression) extends InequalityExpression {
  ...
  override def negated: InequalityExpression = GreaterThanOrEqual(lhs, rhs)
  override def swapped: InequalityExpression = GreaterThan(rhs, lhs)
}
...
final case class LessThanOrEqual(lhs: Expression, rhs: Expression) extends InequalityExpression {
  ...
  override def negated: InequalityExpression = GreaterThan(lhs, rhs)
  override def swapped: InequalityExpression = GreaterThanOrEqual(rhs, lhs)
}
...
final case class GreaterThan(lhs: Expression, rhs: Expression) extends InequalityExpression {
  ...
  override def negated: InequalityExpression = LessThanOrEqual(lhs, rhs)
  override def swapped: InequalityExpression = LessThan(rhs, lhs)
}
...
final case class GreaterThanOrEqual(lhs: Expression, rhs: Expression) extends InequalityExpression {
  ...
  override def negated: InequalityExpression = LessThan(lhs, rhs)
  override def swapped: InequalityExpression = LessThanOrEqual(rhs, lhs)
}
