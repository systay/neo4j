...
public class NonUniqueIndexAccessorCompatibility extends IndexAccessorCompatibility
{
    ...
    public void testIndexSeekAndScan() throws Exception
    {
        updateAndCommit( asList(
                add( 1L, PROPERTY_KEY_ID, "a", new long[]{1000} ),
                add( 2L, PROPERTY_KEY_ID, "a", new long[]{1000} ),
                add( 3L, PROPERTY_KEY_ID, "b", new long[]{1000} ) ) );
    ...
    public void testIndexRangeSeekByNumberWithDuplicates() throws Exception
    {
        updateAndCommit( asList(
                ...
                add( 2L, PROPERTY_KEY_ID, -5, new long[]{1000} ),
                add( 3L, PROPERTY_KEY_ID, 0, new long[]{1000} ),
                add( 4L, PROPERTY_KEY_ID, 5, new long[]{1000} ),
                add( 5L, PROPERTY_KEY_ID, 5, new long[]{1000} ) ) );
    ...
    {
        updateAndCommit( asList(
                add( 1L, PROPERTY_KEY_ID, "Anna", new long[]{1000} ),
                add( 2L, PROPERTY_KEY_ID, "Anna", new long[]{1000} ),
                add( 3L, PROPERTY_KEY_ID, "Bob", new long[]{1000} ),
                add( 4L, PROPERTY_KEY_ID, "William", new long[]{1000} ),
    ...
    public void testIndexRangeSeekByPrefixWithDuplicates() throws Exception
    {
        updateAndCommit( asList(
                ...
                add( 5L, PROPERTY_KEY_ID, "apa", new long[]{1000} ) ) );
    ...
    public void testIndexFullSearchWithDuplicates() throws Exception
    {
        updateAndCommit( asList(
                ...
                add( 3L, PROPERTY_KEY_ID, "apa", new long[]{1000} ),
                add( 4L, PROPERTY_KEY_ID, "apa", new long[]{1000} ),
                add( 5L, PROPERTY_KEY_ID, "apalong", new long[]{1000} ) ) );
