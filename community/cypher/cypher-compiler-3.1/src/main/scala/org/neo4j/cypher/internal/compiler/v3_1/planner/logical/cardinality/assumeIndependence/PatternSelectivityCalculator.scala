...
import org.neo4j.cypher.internal.ir.v3_1.{Cardinality, IdName, PatternRelationship, Selections, Selectivity, SimplePatternLength, VarPatternLength}
...
case class PatternSelectivityCalculator(stats: GraphStatistics, combiner: SelectivityCombiner) extends Pattern2Selectivity {
  ...
  import org.neo4j.cypher.internal.compiler.v3_1.planner.logical.cardinality.assumeIndependence.PatternSelectivityCalculator._
